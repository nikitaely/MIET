...
HD_PWD='/home/pin_31d_13/Desktop/msis/lab3/lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rf_riscv.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rf_riscv.tcl
